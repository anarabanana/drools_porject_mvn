									...
									afterChangesObserved : function() {
										...
										function drawChart() {
											...
											var data = google.visualization.arrayToDataTable([
													[ 'Category', '%' ], [ 'Servers', servers_total ],
											...
											var data_energy = google.visualization.arrayToDataTable([
													[ 'Category', '%' ], [ 'Servers', servers_energy ],
													[ 'PCs', pcs_energy ], [ 'AV', av_energy ],
													[ 'Phones', telephony_energy ],
													[ 'Imaging', imaging_energy ],
													[ 'Networking', networks_energy ] ]);
											var data_carbon = google.visualization.arrayToDataTable([
													[ 'Category', '%' ], [ 'Servers', servers_carbon ],
											...
											var chart_energy = new google.visualization.PieChart(document
