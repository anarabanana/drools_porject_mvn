		...
		<div class="form-mini-container">
			...
			<form class="form-mini">
				...
				<div class="form-radio-buttons" id="V1">
					<div>
						<label><span>1. Equipment
procurement compliance with Green ICT guidelines</span>

							<li>Use eco-labeled devices</li>
					...
					<div>
						<label><span>Optimizing enterprise operations</span>

							<li>Use cloud computing</li>
							...
							<li>Turn off peripherals, or set them to stand-by mode
								respectively</li>
							<li>Enable PC energy saving functions</li>
							<li>Use multifunction devices</li>
							<li>Adjust monitor's brightness</li>
							<li>Energy saving mode on computer monitors</li>
							<li>Duplex printing, Colour print-outs reduction</li>
							<li>Toner disposal, Printing centralization</li> </label>
					</div>
				...
				<div class="form-radio-buttons" id="V2">
					<div>
						<label> <span>2. Energy performance improvement and monitoring </span>
							<li>Integration into management system (Green IT officer)</li>
					...
					<div>
						<label> <span> Use of alternative energy </span>
