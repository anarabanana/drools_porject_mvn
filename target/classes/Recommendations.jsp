				...
				<div class="form-radio-buttons" id="V1">
					<div>
						<div>
							...
							assumed to fulfill partially/completely based on responses. <br>Please hover over each item to see
							more.
						</div>
							...
							<div class="panel" id="panel_1_1">
								...
								programme to help institutions buy the greenest computers and monitors possible. <br> <a
									href="http://www.epeat.net/">Reference</a>
							</div>
							...
							<div class="panel" id="panel_1_2">
								...
								or recycling). <br> <a href="http://lcatogo.simpple.com/intros/index">The LCAtogo
									Tool </a> supports SMEs in conducting the environmental assessment of their products, based on
								LCA and considering their entire life cycle. To simplify the analysis of the results, Key
								Performance Indicators (KEPIs) has been defined for the following sectors: Industrial
								machines, Electronics, Printed Circuit Boards, Renewable Energy - Photovoltaics,
								Semiconductors, Sensors, Smart Textiles. <br>Reference - <a
									href="https://www.solidworks.com/sustainability/sustainable-design-guide/lca-detailed-overview.htm">LCA
									procedure</a>
							</div>
							...
							<div class="panel" id="panel_1_4">
								...
								capacity compared to the energy consumption. <br>Reference - <a
									href="http://www.ictknowledgebase.org.uk/replacementstrategy?type=98">Strategy</a>
							</div>
					...
					<div>
						<label> <span>2. Energy performance improvement and monitoring </span>
							...
							<div class="panel" id="panel_2_4_4">When considering imaging equipment such as
								...
								printers, scanners etc. with multi-functional devices and also review the location of
								equipment. By placing printers in shared areas, rather than in team areas it is possible to
						...
						<label> <span>3. Energy aware networks engineering adherence </span>
							...
							<div class="panel" id="panel_3_1">
								...
								(Power Over Ethernet). <br>Reference - <a
									href="http://blogs.cisco.com/smallbusiness/understanding-the-different-types-of-ethernet-switches">Cisco
					...
					<div>
						<label> <span>5. Waste management </span>
							...
							<div class="panel" id="panel_5_2_1">There are many electronics recycling organisations
								...
								about arranging regular collection of used cartridges for refill and reuse.</div> </label>
					<br>Based on<b>"Best Environmental
Management Practice in the
Telecommunications and ICT
Services Sector"</b>, EU Draft Background Report for the development of
an EMAS Sectoral Reference Document, November 2015
					</div>
				</div>
			</form>
		</div>
