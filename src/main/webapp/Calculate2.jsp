...
<!-- <SCRIPT src="http://handsontable.github.io/handsontable-ruleJS/lib/RuleJS/lib/lodash/lodash.js"
	...
	type="text/javascript"></SCRIPT>
	<SCRIPT src="assets/numeral.js"
	type="text/javascript"></SCRIPT>
	<SCRIPT src="assets/numeric.js"
	type="text/javascript"></SCRIPT>
	<SCRIPT src="assets/md5.js"
	type="text/javascript"></SCRIPT>
	<SCRIPT src="assets/jstat.js"
	type="text/javascript"></SCRIPT>
	<SCRIPT src="assets/formula.js"
	type="text/javascript"></SCRIPT>
	<SCRIPT src="assets/parser.js"
	type="text/javascript"></SCRIPT>
	<SCRIPT src="assets/ruleJS.js"
	type="text/javascript"></SCRIPT>
	<SCRIPT src="assets/handsontable.formula.js"
	type="text/javascript"></SCRIPT>
					...
					function() {
						...
						var data = [
								...
								[ "3", "Small scale servers", 3, 100, '=(C3*D3)', 8760, , ,
										'=+((E3*F3)/1000)' ],
								[ "4", "Storage & other server equipment (d)", , , , , , 0,
										'=(I2*H4)+(I3*H4)' ],
								...
								[ "10", "PCs & Monitors", "Number", "Watts (Active, idle) (f)",
										"Watts (Standby) (f)", "Hours (Active, idle) (g)",
										"Hours (Standby) (g)", "kWh/y per PC", "Total kWh/y" ],
								...
								[ "21", "", , , , , , , '' ],
								[ "22", "", , , , , , , '' ],
								[ "23", "Networks", "Number", "Watts/unit (h)", , "Hours/y", , ,
										"Total kWh/y" ],
								...
								[ "34", "Phones", "Number", "Watts/unit", "Total Watts", "Hours/y",
								...
								[ "45", "High/medium volume copiers/MFDs (o)", '0', '1000', "29", "520",
										"=8760-F45", '=+(D45*F45+E45*G45)/1000', "=+(H45*C45)" ],
								[ "46", "Low/medium volume copiers/MFDs (o)", '10', '600', "19", "520",
										"=8760-F46", '=+(D46*F46+E46*G46)/1000', "=+(H46*C46)" ],
								[ "47", "Networked monochrome laser printers (p)", '10', '440', "15", "520",
										"=8760-F47", '=+(D47*F47+E47*G47)/1000', "=+(H47*C47)" ],
								[ "48", "Networked colour laser printers (p)", '10', '500', "30", "520",
										"=8760-F48", '=+(D48*F48+E48*G48)/1000', "=+(H48*C48)" ],
								...
								[ "58", "Plasma screens ( 61' screen) (u1)", 0, "700", "3", 8000,
										"=(8760-F58)", , "=(C58*(D58*F58+E58*G58))/1000" ],
					    ...
					    var hot = new Handsontable(container,
								{
									...
									cell: [
									       ...
									       {row: 5, col: 8, readOnly: true},
									       {row: 6, col: 8, readOnly: true},
									       
									       /* PCS */
									       
									       {row: 10, col: 7, readOnly: true},
									       {row: 11, col: 7, readOnly: true},
									       {row: 12, col: 7, readOnly: true},
									       {row: 13, col: 7, readOnly: true},
									       {row: 14, col: 7, readOnly: true},
									       {row: 15, col: 7, readOnly: true},
									       
									       {row: 10, col: 8, readOnly: true},
									       {row: 11, col: 8, readOnly: true},
									       {row: 12, col: 8, readOnly: true},
									       {row: 13, col: 8, readOnly: true},
									       {row: 14, col: 8, readOnly: true},
									       {row: 15, col: 8, readOnly: true},
									       {row: 16, col: 8, readOnly: true},
									       {row: 17, col: 8, readOnly: true},
									       {row: 18, col: 8, readOnly: true},
									       {row: 19, col: 8, readOnly: true},
									       
									       
									       /* Networks */
									       
									     
									       {row: 23, col: 5, readOnly: true},
									       {row: 24, col: 5, readOnly: true},
									       {row: 25, col: 5, readOnly: true},
									       {row: 26, col: 5, readOnly: true},
									       {row: 27, col: 5, readOnly: true},
									       {row: 28, col: 5, readOnly: true},
									       {row: 29, col: 5, readOnly: true},
									       {row: 30, col: 5, readOnly: true},
									       
									       {row: 23, col: 8, readOnly: true},
									       {row: 24, col: 8, readOnly: true},
									       {row: 25, col: 8, readOnly: true},
									       {row: 26, col: 8, readOnly: true},
									       {row: 27, col: 8, readOnly: true},
									       {row: 28, col: 8, readOnly: true},
									       {row: 29, col: 8, readOnly: true},
									       {row: 30, col: 8, readOnly: true},
									       
									       /*Phones */
									       
										      // {row: 22, col: 8, readOnly: true},
										       {row: 34, col: 8, readOnly: true},
										       {row: 35, col: 8, readOnly: true},
										       {row: 36, col: 8, readOnly: true},
										       {row: 37, col: 8, readOnly: true},
										       
										       /* Imaging */
							
										       
										       {row: 41, col: 8, readOnly: true},
										       {row: 42, col: 8, readOnly: true},
										       {row: 43, col: 8, readOnly: true},
										       {row: 44, col: 8, readOnly: true},
										       {row: 45, col: 8, readOnly: true},
										       {row: 46, col: 8, readOnly: true},
										       {row: 47, col: 8, readOnly: true},
										       {row: 48, col: 8, readOnly: true},
										       {row: 49, col: 8, readOnly: true},
										       {row: 50, col: 8, readOnly: true},
										       {row: 51, col: 8, readOnly: true},
										       
										       {row: 41, col: 7, readOnly: true},
										       {row: 42, col: 7, readOnly: true},
										       {row: 43, col: 7, readOnly: true},
										       {row: 44, col: 7, readOnly: true},
										       {row: 45, col: 7, readOnly: true},
										       {row: 46, col: 7, readOnly: true},
										       {row: 47, col: 7, readOnly: true},
										       {row: 48, col: 7, readOnly: true},
										       {row: 49, col: 7, readOnly: true},
										       {row: 50, col: 7, readOnly: true},
										       
										       
										       /*AV */
										       
											     
											       {row: 55, col: 8, readOnly: true},
											       {row: 56, col: 8, readOnly: true},
											       {row: 57, col: 8, readOnly: true},
											       {row: 58, col: 8, readOnly: true},
											       
											       /*Total table */
											       
												      // {row: 22, col: 8, readOnly: true},
												       {row: 62, col: 2, readOnly: true},
												       {row: 63, col: 2, readOnly: true},
												       {row: 64, col: 2, readOnly: true},
												       {row: 65, col: 2, readOnly: true},
												       {row: 66, col: 2, readOnly: true},
												       {row: 67, col: 2, readOnly: true},
												       {row: 68, col: 2, readOnly: true},
												       
												       {row: 62, col: 3, readOnly: true},
												       {row: 63, col: 3, readOnly: true},
												       {row: 64, col: 3, readOnly: true},
												       {row: 65, col: 3, readOnly: true},
												       {row: 66, col: 3, readOnly: true},
												       {row: 67, col: 3, readOnly: true},
												       {row: 68, col: 3, readOnly: true},
												       
												       {row: 62, col: 4, readOnly: true},
												       {row: 63, col: 4, readOnly: true},
												       {row: 64, col: 4, readOnly: true},
												       {row: 65, col: 4, readOnly: true},
												       {row: 66, col: 4, readOnly: true},
												       {row: 67, col: 4, readOnly: true},
												       {row: 68, col: 4, readOnly: true},
												       
												       {row: 72, col: 2, type: 'handsontable',
									  ...
									  afterSelection: function (row, col, row2, col2) {
									    ...
									    cells: function (row, col, prop) {
									        ...
									        if (row === 0|| row === 9|| row === 22|| row === 33||row === 40|| row === 54||row === 61 ) {
									        ...
									        if(row === 1 && col===2 ||row === 2 && col===2
									           ...
									           ||row === 13 && col===2 ||row === 14 && col===2 ||row === 15 && col===2	
									           ||row === 16 && col===2 ||row === 17 && col===2	||row === 23 && col===2	
									           ||row === 24 && col===2 ||row === 25 && col===2 ||row === 26 && col===2	
									           ||row === 27 && col===2 ||row === 28 && col===2	||row === 29 && col===2	
									           
									           ||row === 41 && col===2 ||row === 42 && col===2 ||row === 43 && col===2	
									           ||row === 44 && col===2 ||row === 45 && col===2	||row === 46 && col===2	
									           ||row === 47 && col===2 ||row === 48 && col===2 ||row === 49 && col===2	
									           ||row === 50 && col===2  
									           ||row === 55 && col===2	||row === 56 && col===2	
									           ||row === 57 && col===2 ||row === 34 && col===2 ||row === 35 && col===2	
									           ||row === 36 && col===2 ||row === 71 && col===2	||row === 72 && col===2	
									           ||row === 5 && col===7 
									...
									afterChangesObserved : function() {
										...
										function drawChart() {
											...
											var data_carbon = google.visualization.arrayToDataTable([
													...
													[ 'Phones', telephony_carbon ],
													[ 'Imaging', imaging_carbon ],
											...
											var chart_energy = new google.visualization.AreaChart(document
